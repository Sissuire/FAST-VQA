...
% Compile Source File
src = 'FAST_matlab.cpp FAST-VQA/FAST-VQA/FAST.cpp FAST-VQA/FAST-VQA/FAST_fun.cpp FAST-VQA/FAST-VQA/FAST_def.cpp';

cmd = sprintf('mex  -IFAST-VQA/FAST-VQA %s %s', mex_flags, src);
eval(cmd); 
